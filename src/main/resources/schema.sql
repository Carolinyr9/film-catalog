...
-- Corresponds to Review.java and its One-to-One relationship with UserWatched
CREATE TABLE reviews (
    ...
    PRIMARY KEY (user_id, movie_id),
    CONSTRAINT fk_review_userwatched FOREIGN KEY (user_id, movie_id) REFERENCES user_watcheds(user_id, movie_id) ON DELETE CASCADE
);
...
-- Corresponds to ContentFlag.java
CREATE TABLE content_flags (
    reporter_user_id BIGINT NOT NULL,
    review_user_id BIGINT NOT NULL,
    review_movie_id BIGINT NOT NULL,
    flagged_at TIMESTAMP NOT NULL,
    flag_reason VARCHAR(255) NOT NULL,
    PRIMARY KEY (reporter_user_id, review_user_id, review_movie_id),
    CONSTRAINT fk_flag_reporter FOREIGN KEY (reporter_user_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_flag_review FOREIGN KEY (review_user_id, review_movie_id) REFERENCES reviews(user_id, movie_id) ON DELETE CASCADE
);